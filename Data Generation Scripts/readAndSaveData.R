...
if (cluster){
  iFol="/p/projects/open/Fabian/calc/irrigHist/data/"
  oFol="/p/projects/open/Fabian/calc/irrigHist/plots/"
}else{
  iFol="/media/Storage/irrigation/data/"
  oFol="/media/Storage/irrigation/plots/"
}
...
cellarea <- (111194.9/12)*(111194.9/12)*cos(lat/180*pi) # cellarea in m2
